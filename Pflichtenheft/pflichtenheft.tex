...
\begin{document}
    ...
    % notwendige Funktionen.
        % Die Nutzer sollen durch das Produkt in die Lage versetzt werden, ESM-Versuche durchzuführen und Feedbacks der Studie zu erhalten.\\
...
%             \par \textbf{Ziel: }\gls{Proband} kann im Laufen der Studie sehen, ob er so viele Fragen wie erforderlich beantwortet hat
...
%                     \item Im Laufen der Studie wird diesen Status stets aktualisiert. Der \gls{Proband} kann den eigenen Status immer nachsehen.
%                     \item Am Ende einer Studie kann der \gls{Proband} das Smartphone zum \gls{Studienleiter} zeigen. Der \gls{Studienleiter} sieht auf dem Smartphone keinen \gls{Proband}-ID oder genaue \gls{Antwortquote}, sondern nur “bestanden” oder “nicht bestanden”. So kann der \gls{Studienleiter} die Vergütung entsprechend zahlen.
%                 \end{enumerate}
        ...
        \section{\gls{Studienleiter}daten}
            \begin{itemize}
                ...
                \item \textbf{/D20/} Macht ein \gls{Studienleiter} Versuche, dann sind folgende Daten zu speichern:
                    \par Studie-ID der zum \gls{Studienleiter} gehörten Studie
            \end{itemize}
        ...
        \section{Studiendaten}
            \begin{itemize}
                \item \textbf{/D50/} Über einen Versuch sind folgende Daten zu speichern:
                    \par Studie-ID, Studiename, Anfangs- und Endedatum, Mailadresse der \gls{Studienleiter}
