...
\begin{document}
    ...
    \chapter{Produkteinsatz}
        Das Produkt dient zur Sammlung der Versuchsdaten aus ESM-Studien. Damit bietet sie für \gls{Studienleiter} eine Lösung, ESM-Studien durchzuführen. Diese Tätigkeit soll zusätzlich im Internet und auf dem Smartphone möglich sein.
        ...
        \section{\gls{Studienleiter}daten}
            \begin{itemize}
                ...
                \item \textbf{/D20/} Macht ein \gls{Studienleiter} Versuche, dann sind folgende Daten zu speichern:
                    \par Versuchsummern der zum \gls{Studienleiter} gehörten Studien
            \end{itemize}
