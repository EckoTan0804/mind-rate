    ...
    \chapter{Funktionale Anforderungen}
        ...
        \section{Web-Interface}
            \begin{itemize}
                ...
                \par \textbf{Ziel: }Studienleiter können verschiedene \gls{Erscheinungsereignis}se für Fragebögen einstellen.
                \par \textbf{Vorbedingung: }Angemeldet in dem Verwaltungssystem und mindestens eine Studie vorhanden
                \par \textbf{Nachbedingung (Erfolg): }Ein neuer Frageboden mit \gls{Erscheinungsereignis}sen wird erstellt, oder die \gls{Erscheinungsereignis}se eines vorliegenden Fragebogens wird eingestellt.
                \par \textbf{Nachbedingung (Fehlschlag): }Ein neuer Fragebogen wird nicht erstellt, oder ein vorliegender Fragebogen hat keine Änderung.
                \par \textbf{Akteure: }\gls{Studienleiter}
                \par \textbf{Auslösendes Ereignis: }Der \gls{Studienleiter} klickt auf ``Start condition''
        ...
        \section{Android-App}
            ...
            \begin{itemize}
		        ...
		        \par \textbf{Vorbedingung: }ein Fragebogen hat bestimmtes \gls{Erscheinungsereignis} und wird noch nicht ausgelöst
		        ...
		        \par \textbf{Auslösendes Ereignis: }die App entdeckt ein \gls{Erscheinungsereignis} eines Fragebogens
		        \par \textbf{Beschreibung: }
		        \par Wenn ein \gls{Erscheinungsereignis} eines Fragebogen der Studie entdeckt wird, schickt die App eine Notifikation auf dem Handy und der Fragebogen wird auf ``Homepage'' Seite gezeigt.
		        \par \textbf{Alternativen: }
