...
\begin{document}
    ...
    \newglossaryentry{Antwortquote}{name=Antwortquote, description={der Quotient aus beantworteten Fragen und allen Fragen (Die Antwortquoten sind also für jeden Proband unterschiedlich.)}}
    ...
    \section{\gls{Android-App}}
        ...
        \begin{itemize}
            ...
            \item \textbf{(Wunsch) /F100/ Sehen der eigenen \gls{Antwortquote}\footnote{\gls{Antwortquote}: der Quotient aus beantworteten Fragen und allen Fragen. (Die \gls{Antwortquote}n sind also für jeden \gls{Proband} unterschiedlich.)}}
