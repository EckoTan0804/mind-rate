...
=======
                ...
                \item \textbf{/F20/Veränderung des Passworts von dem Leiter}	

                    \par \textbf{Ziel: }Vergessenes Passwort neu zu setzen
                    \par \textbf{Vorbedingung: }Registrieren auf der Webseite
                    \par \textbf{Nachbedingung (Erfolg): }Das neue Passwort wird in dem Datenbank gespeichert.
                    \par \textbf{Nachbedingung (Fehlschlag): }Das alte Passwort wird nicht übergedeckt.
                    \par \textbf{Akteure: }Versuchsleiter
                    \par \textbf{Auslösendes Ereignis: }Der Versuchsleiter vesucht,den “Passwort Vergessen“ Button auf der Webseite zu klicken
                    \par \textbf{Beschreibung: }
		            	\begin{enumerate}
                            ...
                            \item Der Versuchsleiter ist in die “Passwort neu setzen” Seite weitergeleitet
...
>>>>>>> f2972887386affeadfbc8004f336e93568c42fc5
