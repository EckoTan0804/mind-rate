...
\begin{document}
    ...
    % notwendige Funktionen.
        ...
        \noindent Das Produkt besteht aus zwei Teilsysteme: ein \gls{Web-Interface} f\"ur den \gls{Versuchsleiter} und eine Android-Anwendung f\"ur die \gls{Proband}en.
        ...
        \section{Musskriterien}
            ...
            \subsection{\gls{Web-Interface} f\"ur \gls{Versuchsleiter}}
                ...
                \subsubsection{Verwalten von Teilnehmer der Untersuchung}
                    \begin{itemize}
                        \item \gls{Proband}sstatus erfassen (z.B. \gls{Proband}-ID, Alter, Geschlecht, Beruf)
                ...
                \subsubsection{Verwalten der Frageb\"ogen}
                    \begin{itemize}
                        ...
                        \item Erstellen, \"Andern von Untersuchungsfragen f\"ur unterschiedliche \gls{Proband}sgruppe
                        ...
                        % \item Senden von Feedback und Motivation zu \gls{Proband}en
                    \end{itemize}
    ...
    \chapter{Produktumgebung}
        Eine Client-Server Architektur mit 2 Client-Typen: ein \gls{Web-Interface} für \gls{Versuchsleiter} und eine Android-App für \gls{Proband}en
		...
		\section{\gls{Web-Interface}}
	        \begin{itemize}
	            ...
	            \begin{enumerate}
	            	...
	            	\item Der \gls{Versuchsleiter} empfängt ein Bestätigungsemail mit einem Link
	            	\item Durch den Link ist der \gls{Versuchsleiter} in die “Passwort neu setzen” Seite weitergeleitet
	            ...
	            \par \textbf{Akteure: }\gls{Versuchsleiter}
	            \par \textbf{Auslösendes Ereignis: }Der \gls{Versuchsleiter} vesucht, den ``neu'' Button auf der Webseite zu klicken
	            \par \textbf{Beschreibung: }
	            \begin{enumerate}
	            	\item Verwaltung des Versuchs
	            	\par Der \gls{Versuchsleiter} wählt zuerst einen Versuch aus oder erstellt er einen neuen Versuch. Zudem gehört die neue Frage.
	            	\item Erstellung der Fragen
	            	\par Der \gls{Versuchsleiter} entscheidet sich die Fragenart und Antwortart. Dann soll der \gls{Versuchsleiter} auch konkrete Frage eingeben.
	            	\item Zeiteinstellung
	            	\par Der \gls{Versuchsleiter} stellt die Antwortfrist und die Push-Zeit der Frage ein.
	            	\item Hardwareunterstützung(bzw. Sensoren)
	            	\par Der \gls{Versuchsleiter} fügt die Sensoren hinzu. Die Sensoren sollen während der Antwort von dem \gls{Proband} benutzt werden.
                    \item Verwaltung der Beziehungen zwischen Fragen
                    \par Der \gls{Versuchsleiter} entscheidet sich, welche Frage und welche Option das auslösende Ereignis dieser Frage ist.
	            	\item Abschicken und Stornieren
	            	\par Der \gls{Versuchsleiter} entscheidet sich, ob er die Frage eines Versuchs hinfügt oder storniert.
	            \end{enumerate}
	            \par \textbf{Erweiterung: }
	            \begin{enumerate}
	            	...
	            	\item a. Der \gls{Versuchsleiter} kann sich entscheiden,ob diese Frage eine Frist hat. Falls ja, soll der \gls{Versuchsleiter}  einen exakten Zeitraum auswählen.
	            	\par b. Der \gls{Versuchsleiter} soll eine Push-Zeit für diese Frage hinfügen. Er kann sich noch entscheiden, ob die Push-Zeit dem Zeitraum des \gls{Proband}es entsprechend ist.
	            	\item Der \gls{Versuchsleiter} kann sich entscheiden, wie viele und welche Sensoren benutzt werden sollen. Wenn ein Sensor hingefügt ist, soll der \gls{Versuchsleiter} einen Zahlenwert (z. B. Temperatur) für den Sensor eingeben.
	            ...
	            \par \textbf{Ziel: }Senden von Feedbacks (Motivation), um \gls{Proband} zu motivieren, die Studie weiter zu beteiligen.
	            \par \textbf{Vorbedingung: }Der \gls{Versuchsleiter} ist angemeldet.
    ...
    \section{Android-App}
        ...
        \begin{itemize}
            \item \textbf{/F60/Anmelden der \gls{Proband}en}

				\par \textbf{Ziel: }Anmelden der \gls{Proband}en in der App und Sammeln der Versuchsteilnehmerdaten während erstem Anmelden
				\par \textbf{Vorbedingung: }-keine-
            ...
            \item \textbf{/F70/Antworten eines Fragebogens}
            	...
            	\par \textbf{Beschreibung: }
            	\par 1. Wenn der \gls{Versuchsleiter} einen Fragebogen sendet, schickt die App eine Notifikation.
            ...
            \item \textbf{(Wunsch) /F1--/ Sehen des eigenen Antwortquotienten\footnote{Antwortquotient: der Quotient aus beantworteten Fragen und allen Fragen. (Die Antwortquotienten sind also für jeden \gls{Proband} unterschiedlich.)}}
            ...
            \par \textbf{Nachbedingung (Erfolg): }die App zeigt den eigenen Antwortquotienten des \gls{Proband}en
            \par \textbf{Nachbedingung (Fehlschlag): }keinen Antwortquotient wird gezeigt
            \par \textbf{Akteure: }\gls{Proband} selbst
            \par \textbf{Auslösendes Ereignis: }\gls{Proband} klickt auf “Mein Antwortquotient” in der App
            \par \textbf{Beschreibung: }
                \begin{enumerate}
                    \item Bei Erstellen eines Fragebogens kann der \gls{Versuchsleiter} eine “Bestehensgrenze” des Antwortquotienten bestimmen. Ein \gls{Proband} braucht also mindestens eine bestimmte Menge von Fragen beantworten, um die Vergütung am Ende zu bekommen. Die Standardbestehensgrenze liegt bei 60\%.
                    ...
                    \item Am Ende eines Versuchs kann der \gls{Proband} das Smartphone zum \gls{Versuchsleiter} zeigen. Der \gls{Versuchsleiter} sieht auf dem Smartphone keinen \gls{Proband}-ID oder genauen Antwortquotient, sondern nur “bestanden” oder “nicht bestanden”. So kann der \gls{Versuchsleiter} die Vergütung entsprechend zahlen.
                \end{enumerate}
    ...
    \chapter{Produktdaten}
        \section{\gls{Versuchsleiter}daten}
            \begin{itemize}
                \item /D10/ Über einen \gls{Versuchsleiter} sind folgende Daten zu speichern:
                    \par Name (Anrede, Titel, Vorname, Nachname), Mailadresse (als Kontonummer im System)

                \item /D20/ Macht ein \gls{Versuchsleiter} Versuche, dann sind folgende Daten zu speichern:
                    \par Versuchsummern der zum \gls{Versuchsleiter} gehörten Versuchen
            \end{itemize}

        \section{\gls{Proband}daten}
            \begin{itemize}
                \item /D30/ Über einen \gls{Proband} sind folgende Daten zu speichern:
                    \par \gls{Proband}-ID, Geburtsdatum, Beruf, Geschlecht, Versuchsnummer des daran beteiligten Versuchs

                \item /D40/ Hat ein \gls{Proband} im Versuch Fragen beantwortet, dann sind folgende Daten zu speichern:
        ...
        \section{Versuchsdaten}
            \begin{itemize}
                \item /D50/ Über einen Versuch sind folgende Daten zu speichern:
                    \par Versuchsnummer, Versuchsname, Anfangs- und Endedatum, “Bestehensgrenze” des Antwortquotienten für die \gls{Proband}en\footnote{Siehe funktionale Anforderungen F1--}, Mailadresse der \gls{Versuchsleiter}

                \item /D60/ Hat ein Versuch \gls{Proband}en, dann sind folgende Daten zu speichern:
                    \par \gls{Proband}-IDs
        ...
        \section{Fragendaten}
            \begin{itemize}
                ...
                \item /D100/ Wird eine Frage von \gls{Proband}en beantwortet, dann sind folgende Daten zu speichern:
                    \par \gls{Proband}-IDs der Antwortgeber, Abgabezeit der Antworten, Inhalt der Antworten
            \end{itemize}
   ...
   \chapter{Nichtfunktionale Anforderungen}
    ...
    %     Benutzungsoberfläche: grundlegende Anforderungen, Zugriffsrechte
        ...
        \subsection{\gls{Web-Interface}}
            ...
            \begin{figure}[ht]
                ...
                \caption{GUI Entwurf - \gls{Web-Interface}}
            \end{figure}
    ...
    \chapter{Globale Testfälle}
            ...
            \begin{itemize}
                ...
                \item \textbf{/TF30/ Verwaltung der Fragen}
                        ...
                        \item \par \textbf{Stand: } Der \gls{Versuchsleiter} ist  angemeldet
                              \par \textbf{Aktion: } Der \gls{Versuchsleiter} klickt auf ``neu'' Button
                        ...
                        \item \par \textbf{Stand: } Webseite für die Verwaltung der Fragen ist geladen
                              \par \textbf{Aktion: } Der \gls{Versuchsleiter} wählt ``hinzufügen'' im Combobox ``Versuch'' aus
                        ...
                        \item \par \textbf{Stand: } Versuch 1 ist vorhanden
                              \par \textbf{Aktion: } Der \gls{Versuchsleiter} wählt ``Versuch 1'' im Combobox ``Versuch'' aus
                              \par \textbf{Reaktion: } Der \gls{Versuchsleiter} kann die konkrete Frage eingeben
                        ...
                        \item \par \textbf{Stand: } Eine konkrete Frage ist eingegeben
                              \par \textbf{Aktion: } Der \gls{Versuchsleiter} wählt eine Art im Combobox ``Fragenart'' aus
                              \par \textbf{Reaktion: } Der \gls{Versuchsleiter} kann die passende Antwortart auswählen
                        ...
                        \item \par \textbf{Stand: } Fragenart und Antwortart ist ausgewählt
                              \par \textbf{Aktion: } Der \gls{Versuchsleiter} klickt auf Checkbox ``Push-Zeit''
                              \par \textbf{Reaktion: } Der \gls{Versuchsleiter} kann einen Zeitpunkt eingeben (00:00:00-23:59:59)
                        ...
                        \item \par \textbf{Stand: } Push-Zeit ist eingegeben
                              \par \textbf{Aktion: } Der \gls{Versuchsleiter} klickt auf Checkbox ``Antwortfrist''.
                              \par \textbf{Reaktion: } Der \gls{Versuchsleiter} kann einen Zeit eingeben.(eine Zahl eingeben und die Einheit auswählen)


                        \item \par \textbf{Stand: } Antwortfrist ist eingegeben
                              \par \textbf{Aktion: } Der \gls{Versuchsleiter} klickt auf Checkbox ``Sensor''
                              \par \textbf{Reaktion: } Der \gls{Versuchsleiter} kann einen Sensor oder mehrere Sensoren hinzufügen.

                        \item \par \textbf{Stand: } Sensor ist aufgestellt
                              \par \textbf{Aktion: } Der \gls{Versuchsleiter} klickt auf Checkbox ``Vorgesetzte Frage''
                              \par \textbf{Reaktion: } Der \gls{Versuchsleiter} kann eine vorhandene Frage als die Voraussetzung dieser Frage auswählen

 
                        \item \par \textbf{Stand: } Beziehungen zwischen Fragen ist aufgestellt
                              \par \textbf{Aktion: } Der \gls{Versuchsleiter} klickt auf ``submit''
                              \par \textbf{Reaktion: } Ein Dialogfeld ``Diese Frage ist erfolgreich hinzugefügt.'' erscheint

                        \item \par \textbf{Stand: } Beziehungen zwischen Fragen ist aufgestellt
                              \par \textbf{Aktion: } Der \gls{Versuchsleiter} klickt auf ``cancel''
                ...
                \item \textbf{/TF40/ Antwortsstatus besichtigen}
                    \begin{enumerate}
                        ...
                        \item \par \textbf{Stand: } Der \gls{Versuchsleiter} bleibt in der Seite ``View Answers''
                              \par \textbf{Aktion: } Der \gls{Versuchsleiter} gibt einige Bedingungen ein und klickt er den Button ``Confirm''
                    ...
                    \end{enumerate}
                    % \begin{itemize}
                    %     \item Durch Klicken von Button ``View answers'' in der linke Men\"u siehe der \gls{Versuchsleiter} die \"Ubersicht von allen Antwort des aktuellen Fragebogens. \\
                ...
                \item \textbf{/TF45/ Feedback (Motivation) senden}
                    ...
                    \begin{enumerate}
                        ...
                        %       \par \textbf{Reaktion: }
                    \end{enumerate}
                    % \par Durch Klicken von Button ``Send Motivation / Feedback'' sieht der \gls{Versuchsleiter} die Seite, wo er Motivation und Feedback schreiben und senden kann.
        ...
        \subsection{Android-Anwendung}
            ...
            \item \textbf{/TF60/ Anmelden der \gls{Proband}en}
            \begin{enumerate}
            	\item \par \textbf{Stand: } 
            	\par \textbf{Aktion: }
            	\par \textbf{Reaktion: }
