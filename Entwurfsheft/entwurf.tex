...
\newcommand\JSONvaluestyle{\color{blue}}
                ...
                \item \code{class StudyDirector}
                    ...
                    \item \code{class Proband}
                        \begin{itemize}
                            ...
                            \item \code{birthdayRequired: boolean}
                            \item \code{occupation}
                            \item \code{occupationRequired: boolean}
                            \item \code{gender}
                            \item \code{genderRequired: boolean}
                    ...
                    \item \code{class TextQuestion(AbstractQuestion)}
                        \begin{itemize}
                            ...
                            \item \code{def getContent(self): dict}
                                \par // The value of the “content” key is the \code{content} variable.
                        \end{itemize}
                    ...
                    \item \code{class ChoiceQuestion(AbstractQuestion)}
                        ...
                        \begin{itemize}
                            ...
                            \item \code{def getContent(self): dict}
                                \par // The value of the “content” key is the \code{options} list.
                        \end{itemize}
                    ...
                    \item \code{class SteplessScaleQuestion(AbstractQuestion)}
                        ...
                        \item \code{class ScaleQuestionWithSteps(AbstractQuestion)}
                            \begin{itemize}
                                \item \code{hasThreeSteps: boolean}
                                \item \code{hasFiveSteps: boolean}
                                \item \code{hasSevenSteps: boolean}
                                ...
                                \item \code{def getContent(self): dict}
                                   \par // The value of the “stepNumber” key is either 3, 5 or 7. The value of the “stepNames” key is the \code{stepNames} list.
                            \end{itemize}
...
\end{lstlisting}
 ...
 \begin{lstlisting}[style=json]

    {
     ...
     "triggedEvent" : [
        {"sensorName" : "AccelerometerSensor", "event" : "> 1"},
        {"sensorName" : "TemperatureSensor", "event" : "> 15"}
     ],
