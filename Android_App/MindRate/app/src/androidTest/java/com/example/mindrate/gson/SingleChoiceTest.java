...
public class SingleChoiceTest {
    ...
    public void setUp() throws Exception {
        ...
        singleChoice = new SingleChoice(options);
    }
...
//        options.add(new Option("C", "3"));
        test = new SingleChoice(optionArrayList);
        ...
        test = new SingleChoice(optionList);
